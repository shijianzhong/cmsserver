    ...
    module.exports = {
        ...
        data() {
            return {
                ...
                table_data: {
                    columns: [
                        {"key": "ind", "name": "序号", width: 80},
                        {"key": "title", "name": "标题", minWidth: 150},
                        {"key": "address", "name": "地址", minWidth: 120},
                        {"key": "age", "name": "年龄", width: 80},
                        {"key": "name", "name": "姓名", minWidth: 80},
                        {"key": "tel", "name": "电话", minWidth: 120},
        ...
        methods: {
            ...
            ajaxData(){
                ...
                ajax.call(this, '/getSignUpInfo', this.search_data, (obj, err) => {
                    if (!err) {
        ...
        mounted() {
            // this.ajaxData();
            ajax.call(this, '/getSignUpInfo', {}, (data, err) => {
                debugger;
